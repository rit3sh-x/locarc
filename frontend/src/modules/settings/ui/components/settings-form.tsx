...
export const SettingsForm = ({
    ...
    const { phase1, phase2, channelMapping, localization } = initialValues
    const {
        sigBwHz = 200_000,
        perOlf = 0,
        numSamUseRatio = 0.5,
    ...
    const form = useForm({
        defaultValues: {
            'phase1.sigBwHz': sigBwHz,
            'phase1.perOlf': perOlf,
            'phase1.numSamUseRatio': numSamUseRatio,
            'phase1.maxTh': maxTh,
            'phase1.kaiserBeta': kaiserBeta,
            'phase1.highpassOrder': highpassOrder,
            'phase1.highpassCutoff': highpassCutoff,
            'phase1.noiseMinPeaks': noiseMinPeaks,
            'phase1.noiseMaxDiff': noiseMaxDiff,
            'phase2.requiredFs1Hz': requiredFs1Hz,
            'phase2.chSpacingHz': chSpacingHz,
            'phase2.perOlfP1': perOlfP1,
            'phase2.numSamUseRatioP1': numSamUseRatioP1,
            'phase2.maxThP1': maxThP1,
            'phase2.kaiserBetaP1': kaiserBetaP1,
            'phase2.lpfOrder': lpfOrder,
            'phase2.lpfCutoff': lpfCutoff,
            'phase2.noiseMinPeaksP2': noiseMinPeaksP2,
            'phase2.noiseMaxDiffP2': noiseMaxDiffP2,
            'phase2.dcGuardHz': dcGuardHz,
            'powerDetection.enabled': initialValues.powerDetection !== undefined,
            'powerDetection.priorKnowledgeBwHz': pd.priorKnowledgeBwHz,
            'powerDetection.zoomFsPowerHz': pd.zoomFsPowerHz,
            'powerDetection.sigBwPowHz': pd.sigBwPowHz,
            'powerDetection.maxThPow': pd.maxThPow,
            'powerDetection.kaiserBetaPow': pd.kaiserBetaPow,
            'powerDetection.noiseMinPeaksPow': pd.noiseMinPeaksPow,
            'powerDetection.noiseMaxDiffPow': pd.noiseMaxDiffPow,
            'channelMapping.bandStartFreqHz': bandStartFreqHz,
            'channelMapping.bandEndFreqHz': bandEndFreqHz,
            'channelMapping.channelSpacingMapHz': channelSpacingMapHz,
            'channelMapping.powerCalOffsetDb': powerCalOffsetDb,
            'channelMapping.sidelobeDedupHz': sidelobeDedupHz,
            'localization.algorithm': algorithm,
            'localization.pathLossExponent': pathLossExponent,
            'localization.ptSearchRangeMinDbm': ptSearchRangeMinDbm,
