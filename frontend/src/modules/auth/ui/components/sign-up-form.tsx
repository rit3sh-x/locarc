...
export const SignUpForm = ({ onSubmit }: SignUpFormProps): React.JSX.Element => {
    const { setIsTyping, setPasswordExist, setShowPassword, showPassword } = useAuthLayoutContext()
    ...
    return (
        <div className="w-full max-w-md py-4">
            <div className="text-center">
                ...
                <p className="text-white/40 text-sm">Please enter your details to get started</p>
            </div>
            ...
            >
                            ...
                            <Field data-invalid={isInvalid}>
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        onChange={(e) => {
                                            field.handleChange(e.target.value)
                                            setPasswordExist(e.target.value.length > 0)
                                            setIsTyping(true)
                                            setTimeout(() => setIsTyping(false), 600)
                                        }}
                                    />
                ...
                <form.Field name="organizationSlug">
                    {(field) => {
                        ...
                        return (
                            <Field data-invalid={isInvalid}>
                                <FieldLabel className="text-white">Organization</FieldLabel>
                                <Input
                                    value={field.state.value}
                                    onBlur={field.handleBlur}
                                    onChange={(e) => {
