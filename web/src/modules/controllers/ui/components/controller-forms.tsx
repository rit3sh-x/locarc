    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-3xl">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <FieldDisplay
                    label="Latitude"
                    value={controller.latitude.toFixed(6)}
                />
                <FieldDisplay
                    label="Longitude"
                ...
                <FieldDisplay
                    label="VGA Gain"
                    value={`${controller.settings.vgaGain} dB`}
                />
                <FieldDisplay
                    label="LNA Gain"
                    value={`${controller.settings.lnaGain} dB`}
                />
                <FieldDisplay
                    label="Buffer Size"
...
export type EditControllerFormValues = Omit<
    ModifyControllerInput,
    "controllerId"
>;
